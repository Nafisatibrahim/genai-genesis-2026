...
// node_modules/react-muscle-highlighter/dist/esm/index.js
var import_jsx_runtime3 = __toESM(require_jsx_runtime());
var import_react = __toESM(require_react());

// node_modules/react-muscle-highlighter/dist/esm/assets/bodyFront.js
var bodyFront = [
  // Chest
  {
    slug: "chest",
...
// node_modules/react-muscle-highlighter/dist/esm/assets/bodyBack.js
var bodyBack = [
  // Neck
  {
    slug: "neck",
...
// node_modules/react-muscle-highlighter/dist/esm/assets/bodyFemaleFront.js
var bodyFemaleFront = [
  {
    slug: "neck",
    color: "#454545",
...
// node_modules/react-muscle-highlighter/dist/esm/assets/bodyFemaleBack.js
var bodyFemaleBack = [
  {
    slug: "hair",
    color: "#595959",
...
var Body = ({ colors = ["#0984e3", "#74b9ff"], data, scale = 1, side = "front", gender = "male", onBodyPartPress, border = "#dfdfdf", disabledParts = [], hiddenParts = [], defaultFill = "#3f3f3f", defaultStroke = "none", defaultStrokeWidth = 0 }) => {
  ...
  const mergedBodyParts = (0, import_react.useCallback)((dataSource) => {
    ...
    return filteredDataSource.map((assetPart) => {
      ...
      if (!((_a = merged.styles) == null ? void 0 : _a.fill) && !merged.color && merged.intensity) {
  ...
  const getColorToFill = (bodyPart) => {
    ...
    if ((_a = bodyPart.styles) == null ? void 0 : _a.fill) {
  ...
  const renderBodySvg = (bodyToRender2) => {
    const SvgWrapper = gender === "male" ? SvgMaleWrapper : SvgFemaleWrapper;
    return (0, import_jsx_runtime3.jsx)(SvgWrapper, { side, scale, border, children: mergedBodyParts(bodyToRender2).map((bodyPart) => {
      var _a, _b, _c;
      const commonPaths = (((_a = bodyPart.path) == null ? void 0 : _a.common) || []).map((path, index) => {
        const partStyles = getPartStyles(bodyPart);
        const fillColor = getColorToFill(bodyPart);
        return (0, import_jsx_runtime3.jsx)("path", { onClick: isPartDisabled(bodyPart.slug) ? void 0 : () => onBodyPartPress == null ? void 0 : onBodyPartPress(bodyPart), style: {
      ...
      const leftPaths = (((_b = bodyPart.path) == null ? void 0 : _b.left) || []).map((path, index) => {
        var _a2;
        const isOnlyRight = ((_a2 = data.find((d) => d.slug === bodyPart.slug)) == null ? void 0 : _a2.side) === "right";
        const partStyles = getPartStyles(bodyPart);
        const fillColor = isOnlyRight ? defaultFill : getColorToFill(bodyPart);
        return (0, import_jsx_runtime3.jsx)("path", { onClick: isPartDisabled(bodyPart.slug) ? void 0 : () => onBodyPartPress == null ? void 0 : onBodyPartPress(bodyPart, "left"), style: {
          cursor: isPartDisabled(bodyPart.slug) ? "not-allowed" : "pointer",
          opacity: isPartDisabled(bodyPart.slug) ? 0.6 : 1
      ...
      const rightPaths = (((_c = bodyPart.path) == null ? void 0 : _c.right) || []).map((path, index) => {
        var _a2;
        const isOnlyLeft = ((_a2 = data.find((d) => d.slug === bodyPart.slug)) == null ? void 0 : _a2.side) === "left";
        const partStyles = getPartStyles(bodyPart);
        const fillColor = isOnlyLeft ? defaultFill : getColorToFill(bodyPart);
        return (0, import_jsx_runtime3.jsx)("path", { onClick: isPartDisabled(bodyPart.slug) ? void 0 : () => onBodyPartPress == null ? void 0 : onBodyPartPress(bodyPart, "right"), style: {
          cursor: isPartDisabled(bodyPart.slug) ? "not-allowed" : "pointer",
          opacity: isPartDisabled(bodyPart.slug) ? 0.6 : 1
  ...
  const bodyToRender = gender === "female" ? side === "front" ? bodyFemaleFront : bodyFemaleBack : side === "front" ? bodyFront : bodyBack;
  return renderBodySvg(bodyToRender);
};
var esm_default = Body;
export {
  esm_default as default
};
//# sourceMappingURL=react-muscle-highlighter.js.map
